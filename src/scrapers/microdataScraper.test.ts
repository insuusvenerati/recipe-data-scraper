  ...
  items: [
    {
      properties: {
        ...
        author: [
          { properties: { name: ["GF member meganrosepw"] }, type: ["http://schema.org/Person"] },
        ],
...
const testResponse3 = {
  items: [
    ...
    { properties: { url: [""] }, type: ["https://schema.org/Organization"] },
    {
      properties: {
        ...
        url: [
          "https://www.epicurious.com/recipes/food/views/fried-plantain-chips-with-lime-sour-cream-and-mango-hot-sauce",
        ],
        image: [
          "https://assets.epicurious.com/photos/5eea86d764beb86f1288c072/master/pass/fried-plantain-chips-mango-hot-sauce-recipe-061720.jpg",
        ],
        description: [
