    ...
    "@graph": [
      {
        ...
        recipeIngredient: [
          ...
          "5 1/4 cups (631g) King Arthur Unbleached All-Purpose Flour",
          "1/2 cup (50g) King Arthur Organic Pumpernickel Flour or rye flour",
          "1 tablespoon salt",
        ],
        recipeInstructions:
  ...
  [
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          position: 3,
          item: {
            "@id": "https://www.marthastewart.com/1505788/recipes",
            name: "Recipes",
            image: null,
          },
        },
        ...
        },
        {
          ...
          position: 6,
          item: {
            "@id": "https://www.marthastewart.com/1505014/beef-recipes",
            name: "Beef Recipes",
            image: null,
          },
        },
    ...
    },
    {
      ...
      recipeIngredient: [
        ...
        '<a href="https://www.marthastewart.com/340928/steak-butter">Steak Butter</a>',
      ],
      recipeInstructions: [
        {
          "@type": "HowToStep",
      ...
      video: {
        ...
        description:
          "With the right cut of meat, a good cast-iron or ovenproof skillet will turn your kitchen into the best steakhouse in town.",
        uploadDate: "2018-01-24T21:15:25.000Z",
        duration: "PT1M2.187S",
        thumbnailUrl:
          "https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fcf-images.us-east-1.prod.boltdns.net%2Fv1%2Fstatic%2F5985631785001%2F79c4e98c-44ed-4863-93a3-5752b47e2a45%2F504a5749-5618-4a17-a997-a9cb20895a96%2F160x90%2Fmatch%2Fimage.jpg",
        publisher: {
          "@type": "Organization",
          name: "Martha Stewart",
          ...
          sameAs: [
            "https://www.facebook.com/marthastewart/",
            "https://twitter.com/marthaliving/",
            "https://www.pinterest.com/marthastewart/",
            "https://www.instagram.com/marthastewart/",
            "https://www.youtube.com/user/marthastewart/",
          ],
        },
        embedUrl:
          "https://players.brightcove.net/5985631785001/default_default/index.html?videoId=5991067967001",
      },
    },
  ],
];
const testResponse3 = [
  {
    ...
    image:
      "https://assets.bonappetit.com/photos/5d9f645147ff4500091082ad/16:9/w_1000,c_limit/1119-Pies-Lemon-Meringue.jpg",
    ...
    recipeInstructions: [
      ...
      {
        "@type": "HowToStep",
        text: "Do Ahead: Pie (without meringue) can be made 2 days ahead. Keep chilled.",
      },
    ],
    nutrition: "",
  },
...
describe("JsonLdScraper class", () => {
  ...
  const getMeta = (json: any) => json.length > 1 ? json : json[0];
  ...
  describe("test response 1: JSON.parse error", () => {
    ...
    it("invokes the logger with the json-ld errors", () => {
      ...
      loggerStub
        .getCall(1)
        .firstArg.should.eql("Error: No JSON-LD valid script tags present on page");
    });
